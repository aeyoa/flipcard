...
public class DropDownMenu {
    ...
    private final Rotation3D pApplet;

    private final EasingValue menuButtonAngle = new EasingValue(0.15, 0.01);
    private final RoundButton menuButton;
    private boolean isActive;

    private final RectButtonCenter saveButton;
    private final RectButtonCenter clearButton;
    private final RectButtonCenter shuffleButton;
    ...
    public DropDownMenu(final Rotation3D pApplet) {
        ...
        this.saveButton = new RectButtonCenter(pApplet, pApplet.loadImage("save.png"), 700, (int) saveButtonY.getCurrentValue());
        this.shuffleButton = new RectButtonCenter(pApplet, pApplet.loadImage("shuffle.png"), 630, (int) shuffleButtonY.getCurrentValue());
        this.clearButton = new RectButtonCenter(pApplet, pApplet.loadImage("show-learned.png"), 525, (int) clearButtonY.getCurrentValue());
    }
